...
<template>
  <input
    class="inline-block border-b-2 border-dashed border-b-cyan-500 px-2 py-1 text-center text-lg font-bold tracking-wide text-cyan-600 focus:border-b-cyan-700 focus:text-cyan-700 focus:outline-none"
    type="text"
    :value="innerString"
