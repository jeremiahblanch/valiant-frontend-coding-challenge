...
<template>
  <input
    class="inline-block border-b-2 border-dashed border-b-cyan-500 px-2 py-1 text-center text-2xl font-bold tracking-tight text-cyan-500 focus:border-b-cyan-600 focus:outline-none"
    type="text"
    :value="innerString"
